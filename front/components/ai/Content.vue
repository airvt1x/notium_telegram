...
<template>
  <div class="h-full">
    <div ref="container" class="content relative flex h-[92.5%] flex-1 flex-col overflow-y-auto px-8 pt-20">
      <div class="flex h-full flex-col gap-8">
        ...
        >
          ...
          <div
            class="text-[14px] dark:text-zinc-200 md:text-[13px] 2xl:text-[14px] max-w-[300px]"
